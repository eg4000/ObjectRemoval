...
from GibsonEnv.gibson.core.physics.scene_building import SinglePlayerBuildingScene
...
from GibsonEnv.gibson.core.physics.physics_object import PhysicsObject
...
class BaseEnv(gym.Env):
    ...
    """
    def __init__(self, config, scene_type, tracking_camera, pano_type='rgb'):
